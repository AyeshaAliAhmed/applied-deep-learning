...
## About the Project
This project is about predicting the quality of white wine (a score from 1–10)
...
## What I Learned
- Preprocessing — why normalizing input data matters (my loss went from 1.4 million → 0.55 just by adding normalization!)
...
- **Forgetting to normalize** — raw wine features have very different scales
  (e.g. density ≈ 0.998 vs total sulfur dioxide ≈ 114). Without normalization,
